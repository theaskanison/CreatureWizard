...
// Use Vite environment variable syntax (not process.env)
const genAI = new GoogleGenerativeAI(import.meta.env.VITE_GEMINI_API_KEY);

// gemini-2.5-flash-image supports multimodal input (sketch + text)
// and can generate images, unlike text-only models
